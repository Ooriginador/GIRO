...
export default function LicensesPage() {
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    try {
      await apiClient.createLicenses(planType, quantity);
      await loadLicenses();
      setQuantity(1);
    } catch (error: any) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <select
                  ...
                  disabled={creating}
                >
                  <option value="basic">Basic (1 dispositivo)</option>
                  <option value="professional">Professional (3 dispositivos)</option>
