...
describe('Payments Page', () => {
  ...
  describe('Payment History', () => {
    ...
    it('should display mock payments', () => {
      render(<PaymentsPage />);
      // Should show multiple 299.90 values from mock data
      const amountElements = screen.getAllByText(/R\$\s*299,90/);
  ...
  describe('Pricing Plans', () => {
    ...
    it('should display Professional plan', () => {
      render(<PaymentsPage />);
      // Already used in current plan, check for the card
      const profElements = screen.getAllByText('Profissional');
      expect(profElements.length).toBeGreaterThanOrEqual(1);
    });
