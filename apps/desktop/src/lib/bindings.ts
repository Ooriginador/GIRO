...
export const commands = {
  ...
  async getAuditLogs(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_audit_logs', {
          action,
          employeeId,
          startDate,
          endDate,
  ...
  ): Promise<Result<KardexReport, AppError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_product_kardex', {
          productId,
          startDate,
          endDate,
          locationId,
   ...
   */
  async scanNetworkForMasters(
    timeoutSecs: number | null
  ): Promise<Result<DiscoveredMaster[], AppError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('scan_network_for_masters', { timeoutSecs }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async testMasterConnection(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('test_master_connection', { ip, port, secret }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
   ...
   */
  async scanNetworkSubnet(
    baseIp: string | null,
    start: number | null,
    end: number | null
  ): Promise<Result<NetworkScanResult, AppError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('scan_network_subnet', { baseIp, start, end }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async getContractsPaginated(
    ...
    isActive: boolean | null
  ): Promise<Result<PaginatedResult<Contract>, AppError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_contracts_paginated', {
          page,
          perPage,
          search,
          status,
  ...
  async getWorkFrontsByContract(contractId: string): Promise<Result<WorkFront[], AppError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_work_fronts_by_contract', { contractId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async getWorkFrontsBySupervisor(supervisorId: string): Promise<Result<WorkFront[], AppError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_work_fronts_by_supervisor', { supervisorId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async getActivitiesByWorkFront(workFrontId: string): Promise<Result<Activity[], AppError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_activities_by_work_front', { workFrontId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async getActivitiesByCostCenter(costCenter: string): Promise<Result<Activity[], AppError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_activities_by_cost_center', { costCenter }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async updateActivityProgress(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('update_activity_progress', { id, executedQty }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async getStockLocationsByType(locationType: string): Promise<Result<StockLocation[], AppError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_stock_locations_by_type', { locationType }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
   ...
   */
  async getStockLocationsByContract(
    contractId: string
  ): Promise<Result<StockLocation[], AppError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_stock_locations_by_contract', { contractId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
   ...
   */
  async getLocationBalances(
    locationId: string
  ): Promise<Result<StockBalanceWithProduct[], AppError>> {
    try {
  ...
  async adjustLocationBalance(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('adjust_location_balance', {
          locationId,
          productId,
          quantityDelta,
        }),
   ...
   */
  async getMaterialRequestsPaginated(
    page: number | null,
    perPage: number | null,
    filters: RequestFilters | null
  ): Promise<Result<PaginatedResult<MaterialRequest>, AppError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_material_requests_paginated', { page, perPage, filters }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  ): Promise<Result<MaterialRequest[], AppError>> {
    try {
   ...
   */
  async getMaterialRequestByNumber(
    contractId: string,
    requestNumber: string
  ): Promise<Result<MaterialRequest | null, AppError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_material_request_by_number', { contractId, requestNumber }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async addRequestItem(
    requestId: string,
    item: AddRequestItem
  ): Promise<Result<MaterialRequestItem, AppError>> {
    try {
  ...
  async getRequestItems(
    requestId: string
  ): Promise<Result<MaterialRequestItemWithProduct[], AppError>> {
    try {
  ...
  async removeRequestItem(requestId: string, itemId: string): Promise<Result<null, AppError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('remove_request_item', { requestId, itemId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
   ...
   */
  async approveMaterialRequestWithItems(
    id: string,
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('approve_material_request_with_items', { id, items }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async deliverMaterialRequest(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('deliver_material_request', { id, signature }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async getTransfersByDestination(locationId: string): Promise<Result<StockTransfer[], AppError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_transfers_by_destination', { locationId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
   ...
   */
  async getStockTransferByNumber(
    transferNumber: string
  ): Promise<Result<StockTransfer | null, AppError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_stock_transfer_by_number', { transferNumber }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  ): Promise<Result<StockTransferItem, AppError>> {
    try {
  ...
  async shipStockTransfer(
    transferId: string,
    shippedItems: ShipTransferItem[] | null
  ): Promise<Result<StockTransfer, AppError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('ship_stock_transfer', { transferId, shippedItems }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async receiveStockTransfer(
    transferId: string,
    receivedItems: ReceiveTransferItem[] | null
  ): Promise<Result<StockTransfer, AppError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('receive_stock_transfer', { transferId, receivedItems }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
   ...
   */
  async getContractsConsumptionSummary(
    limit: number | null
  ): Promise<Result<ContractConsumptionSummary[], AppError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_contracts_consumption_summary', { limit }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
   ...
   */
  async reportConsumptionByContract(
    contractId: string,
    dateFrom: string | null,
    dateTo: string | null
  ): Promise<Result<ConsumptionReport, AppError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('report_consumption_by_contract', {
          contractId,
          dateFrom,
          dateTo,
        }),
   ...
   */
  async reportConsumptionByActivity(
    activityId: string,
    dateFrom: string | null,
    dateTo: string | null
  ): Promise<Result<ConsumptionReport, AppError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('report_consumption_by_activity', {
          activityId,
          dateFrom,
          dateTo,
        }),
   ...
   */
  async reportConsumptionByCostCenter(
    costCenter: string,
    dateFrom: string | null,
    dateTo: string | null
  ): Promise<Result<CostCenterReport, AppError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('report_consumption_by_cost_center', {
          costCenter,
          dateFrom,
          dateTo,
        }),
   ...
   */
  async reportPendingRequests(
    contractId: string | null
  ): Promise<Result<PendingRequestsReport, AppError>> {
    try {
  ...
  ): Promise<Result<LowStockAlert[], AppError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_low_stock_alerts', { locationId, categoryId, criticality }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
   ...
   */
  async getInventoryCountsPaginated(
    page: number | null,
    perPage: number | null,
    locationId: string | null,
    status: string | null
  ): Promise<Result<PaginatedResult<InventoryCount>, AppError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_inventory_counts_paginated', {
          page,
          perPage,
          locationId,
          status,
  ...
  async getInventoryCountItems(
    countId: string
  ): Promise<Result<InventoryCountItemWithProduct[], AppError>> {
    try {
   ...
   */
  async registerInventoryCountItem(
    itemId: string,
    countedQty: number,
    notes: string | null
  ): Promise<Result<InventoryCountItem, AppError>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('register_inventory_count_item', { itemId, countedQty, notes }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async completeInventoryCount(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('complete_inventory_count', { id, applyAdjustments }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
...
export type ConsumptionByActivity = {
  activityId: string;
  activityName: string;
  activityCode: string;
  totalValue: number;
...
export type ConsumptionReport = {
  ...
  byActivity: ConsumptionByActivity[];
};
/**
 * Contrato/Obra
 */
 ...
 */
export type ContractConsumptionSummary = {
  contractId: string;
  contractCode: string;
  contractName: string;
 ...
 */
export type CreateEnterpriseInventoryCount = {
  locationId: string;
  countType: string;
  notes: string | null;
};
export type CreateFirstAdminInput = { name: string; email: string | null; pin: string };
export type CreateHeldSale = {
  id: string | null;
  customerId: string | null;
  discountValue: number;
  discountReason: string | null;
  items: HeldSaleCartItem[];
};
/**
...
export type CreateServiceOrder = {
  ...
  status: string | null;
  items: CreateServiceOrderItem[] | null;
};
/**
 * Para criar item na criação da OS
 */
export type CreateServiceOrderItem = {
  productId: string | null;
  itemType: string;
  description: string;
  employeeId: string | null;
 ...
 */
export type CreateStockLocation = {
  code: string;
  name: string;
  description: string | null;
 ...
 */
export type EnterpriseDashboardStats = {
 ...
 */
export type InventoryCountItemWithProduct = {
  id: string;
  countId: string;
  productId: string;
  systemQty: number;
  ...
  createdAt: string;
  updatedAt: string;
} & { productName: string; productCode: string; productUnit: string };
 ...
 */
export type PendingRequestsReport = {
  totalPending: number;
  totalValue: number;
  byPriority: PendingByPriority[];
  byContract: PendingByContract[];
 ...
 */
export type PrinterDetectionResultDto = {
...
export type StockBalanceWithProduct = {
  ...
  createdAt: string;
  updatedAt: string;
} & { productName: string; productCode: string; productUnit: string; availableQty: number };
/**
 * Local de Estoque
 */
 ...
 */
export type StockPositionReport = {
  locationId: string;
  locationName: string;
  totalItems: number;
  totalValue: number;
  lowStockItems: number;
  items: StockBalanceWithProduct[];
};
