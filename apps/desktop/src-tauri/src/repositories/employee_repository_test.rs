...
mod tests {
    ...
    async fn test_create_employee() {
        ...
        let input = CreateEmployee {
            ...
            username: Some("joao.silva".to_string()),
    ...
    async fn test_create_employee_duplicate_pin() {
        ...
        let input2 = CreateEmployee {
            ...
            phone: None,
            email: None,
            username: Some("employee2".to_string()),
            pin: "5678".to_string(),
            password: None,
            role: None,
            commission_rate: None,
    ...
    async fn test_authenticate_pin() {
        ...
        let input = CreateEmployee {
            ...
            phone: None,
            email: None,
            username: Some("testauth".to_string()),
            pin: "9999".to_string(),
            password: None,
    ...
    async fn test_find_by_cpf() {
        ...
        let input = CreateEmployee {
            ...
            phone: None,
            email: None,
            username: Some("cpftest".to_string()),
            pin: "1111".to_string(),
            password: None,
            role: None,
            commission_rate: None,
    ...
    async fn test_deactivate_employee() {
        ...
        let input = CreateEmployee {
            ...
            phone: None,
            email: None,
            username: Some("deactivate".to_string()),
            pin: "3333".to_string(),
            password: None,
            role: None,
            commission_rate: None,
    ...
    async fn test_role_formatting() {
        ...
        for (i, role) in roles.iter().enumerate() {
            let input = CreateEmployee {
                ...
                phone: None,
                email: None,
                username: Some(format!("roletest{}", i)),
                pin: format!("40{:02}", i),
                password: None,
                role: Some(*role),
                commission_rate: None,
