#!/usr/bin/env node
/*
 * Accessibility scanner (local) using Playwright found in apps/desktop node_modules
 * Usage: node apps/desktop/scripts/axe-scan.js http://localhost:1420 ../../axe-report.json
 */
